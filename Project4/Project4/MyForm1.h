...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(510, 159);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(219, 50);
			this->button1->TabIndex = 0;
			this->button1->Text = L"billing";
			...
			this->button2->Size = System::Drawing::Size(219, 52);
			...
			this->button3->Text = L"display";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &MyForm1::button3_Click);
			// 
			// button4
			// 
			this->button4->Location = System::Drawing::Point(510, 82);
			...
			this->label1->Text = L"Welcome Patient";
			// 
			// button5
			// 
			this->button5->Location = System::Drawing::Point(12, 25);
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(290, 129);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(169, 23);
			this->button6->TabIndex = 6;
			this->button6->Text = L"setappointment";
			...
			this->ClientSize = System::Drawing::Size(741, 261);
